...
public class BehemothbiterEntity extends Monster {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public BehemothbiterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.BEHEMOTHBITER.get(), world);
	}

	public BehemothbiterEntity(EntityType<BehemothbiterEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.7f);
		xpReward = 0;
		setNoAi(false);
