...
public class NestspittersChaqueMiseAJourDeTickDeLentiteProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		double numberworm = 0;
		numberworm = 0;
		if (Mth.nextInt(RandomSource.create(), 1, 7) == 2) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERS_SMALLS.get()) {
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = FactorioEnemiesModEntities.SMALLSPITTERS.get().spawn(_level,
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERSSMALLSMEDIUM.get()) {
				if (Mth.nextInt(RandomSource.create(), 1, 3) == 2) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = FactorioEnemiesModEntities.MEDIUMSPITTERS.get().spawn(_level,
								BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), -2, 2), y + Mth.nextDouble(RandomSource.create(), 1, 2), z + Mth.nextDouble(RandomSource.create(), -2, 2)), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERSMEDIUM.get()) {
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = FactorioEnemiesModEntities.MEDIUMSPITTERS.get().spawn(_level,
							BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), -2, 2), y + Mth.nextDouble(RandomSource.create(), 1, 2), z + Mth.nextDouble(RandomSource.create(), -2, 2)), MobSpawnType.MOB_SUMMONED);
					if (entityToSpawn != null) {
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERSMEDIUMBIG.get()) {
				if (Mth.nextInt(RandomSource.create(), 1, 3) == 2) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = FactorioEnemiesModEntities.BIGSPITTERS.get().spawn(_level,
								BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), -2, 2), y + Mth.nextDouble(RandomSource.create(), 1, 2), z + Mth.nextDouble(RandomSource.create(), -2, 2)), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERSBIG.get()) {
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = FactorioEnemiesModEntities.BIGSPITTERS.get().spawn(_level,
							BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), -2, 2), y + Mth.nextDouble(RandomSource.create(), 1, 2), z + Mth.nextDouble(RandomSource.create(), -2, 2)), MobSpawnType.MOB_SUMMONED);
					if (entityToSpawn != null) {
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == FactorioEnemiesModBlocks.NESTSPITTERSBIGBEHEMOTH.get()) {
				if (Mth.nextInt(RandomSource.create(), 1, 3) == 2) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = FactorioEnemiesModEntities.BEHEMOTHSPITTERS.get().spawn(_level,
								BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), -2, 2), y + Mth.nextDouble(RandomSource.create(), 1, 2), z + Mth.nextDouble(RandomSource.create(), -2, 2)), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
