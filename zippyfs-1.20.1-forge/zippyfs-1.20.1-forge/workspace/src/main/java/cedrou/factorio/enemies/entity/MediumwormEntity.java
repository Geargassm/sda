...
public class MediumwormEntity extends Monster implements RangedAttackMob {
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public MediumwormEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.MEDIUMWORM.get(), world);
	}

	public MediumwormEntity(EntityType<MediumwormEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
