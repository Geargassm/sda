...
public class BigbiterEntity extends Monster {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public BigbiterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.BIGBITER.get(), world);
	}

	public BigbiterEntity(EntityType<BigbiterEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.7f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new LeapAtTargetGoal(this, (float) 0.9));
