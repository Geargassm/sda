...
public class Modelsmallspitters<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "smallspitters"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = tete.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(-1.7651F, -0.1645F, -0.4096F));
		...
		PartDefinition bone2 = tete.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(-0.2349F, -0.1645F, -0.4096F));
		...
		PartDefinition cube_r2 = pates_avant_doite.addOrReplaceChild("cube_r2",
		...
		PartDefinition cube_r3 = pates_milieu_droit.addOrReplaceChild("cube_r3",
		...
		PartDefinition cube_r4 = pates_millieu_gauche.addOrReplaceChild("cube_r4",
		...
		PartDefinition cube_r5 = pates_arriere_gauche.addOrReplaceChild("cube_r5",
		...
		PartDefinition cube_r6 = pates_arriere_doite.addOrReplaceChild("cube_r6",
