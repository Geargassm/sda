...
public class SmallBiter<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition carapace_r1 = bone.addOrReplaceChild("carapace_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-0.2349F, 0.1645F, 0.4096F, 0.0F, 0.9599F, -0.6109F));

		PartDefinition bone2 = tete.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(-0.2349F, -0.1645F, -0.4096F));

		PartDefinition carapace_r2 = bone2.addOrReplaceChild("carapace_r2", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(0.2349F, 0.1645F, 0.4096F, 0.0F, -0.9599F, 0.6109F));

		PartDefinition p1 = carapace.addOrReplaceChild("p1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition carapace_r3 = p1.addOrReplaceChild("carapace_r3", CubeListBuilder.create().texOffs(12, 0).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition carapace_r4 = p1.addOrReplaceChild("carapace_r4", CubeListBuilder.create().texOffs(12, 0).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition p2 = carapace.addOrReplaceChild("p2", CubeListBuilder.create(), PartPose.offset(2.0F, -0.5F, 2.6F));

		PartDefinition carapace_r5 = p2.addOrReplaceChild("carapace_r5", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, -1.0F, -2.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition carapace_r6 = p2.addOrReplaceChild("carapace_r6", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -2.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition p3 = carapace.addOrReplaceChild("p3", CubeListBuilder.create(), PartPose.offset(0.0F, -0.2F, 4.2F));

		PartDefinition carapace_r7 = p3.addOrReplaceChild("carapace_r7", CubeListBuilder.create().texOffs(10, 9).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition carapace_r8 = p3.addOrReplaceChild("carapace_r8", CubeListBuilder.create().texOffs(10, 9).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition p4 = carapace.addOrReplaceChild("p4", CubeListBuilder.create(), PartPose.offset(2.0F, 0.0F, 5.9F));

		PartDefinition carapace_r9 = p4.addOrReplaceChild("carapace_r9", CubeListBuilder.create().texOffs(10, 5).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition carapace_r10 = p4.addOrReplaceChild("carapace_r10", CubeListBuilder.create().texOffs(10, 5).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition p5 = carapace.addOrReplaceChild("p5", CubeListBuilder.create(), PartPose.offset(2.0F, 0.3F, 7.4F));

		PartDefinition carapace_r11 = p5.addOrReplaceChild("carapace_r11", CubeListBuilder.create().texOffs(0, 5).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition carapace_r12 = p5.addOrReplaceChild("carapace_r12", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition p6 = carapace.addOrReplaceChild("p6", CubeListBuilder.create(), PartPose.offset(2.0F, 0.6F, 8.5F));

		PartDefinition carapace_r13 = p6.addOrReplaceChild("carapace_r13", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition carapace_r14 = p6.addOrReplaceChild("carapace_r14", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
