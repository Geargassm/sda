...
public class SmallspittersEntity extends Monster implements RangedAttackMob {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public SmallspittersEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.SMALLSPITTERS.get(), world);
	}

	public SmallspittersEntity(EntityType<SmallspittersEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
