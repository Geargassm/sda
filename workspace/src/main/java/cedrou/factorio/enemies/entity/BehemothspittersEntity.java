...
public class BehemothspittersEntity extends Monster implements RangedAttackMob {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public BehemothspittersEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.BEHEMOTHSPITTERS.get(), world);
	}

	public BehemothspittersEntity(EntityType<BehemothspittersEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.7f);
		xpReward = 0;
		setNoAi(false);
