...
public class MediumbiterEntity extends Monster {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public MediumbiterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.MEDIUMBITER.get(), world);
	}

	public MediumbiterEntity(EntityType<MediumbiterEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.7f);
		xpReward = 0;
		setNoAi(false);
