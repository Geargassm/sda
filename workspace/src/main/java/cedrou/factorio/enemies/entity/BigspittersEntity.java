...
public class BigspittersEntity extends Monster implements RangedAttackMob {
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public BigspittersEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FactorioEnemiesModEntities.BIGSPITTERS.get(), world);
	}

	public BigspittersEntity(EntityType<BigspittersEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.7f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RangedAttackGoal(this, 1.25, 30, 10f) {
			@Override
